    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">ODIN Observer</h1>
          <p className="text-sm text-slate-400 mt-1">Monitorización ejecutiva en tiempo real</p>
        </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 backdrop-blur">
          ...
          <p className="text-xs text-center text-slate-500 mt-4">
            Solo usuarios autorizados de InnovaDataCO
          </p>
        </div>
      </div>
    </div>
